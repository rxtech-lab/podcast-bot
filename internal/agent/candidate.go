...
Anti-repetition rule: your private memory contains every line spoken so far, including your own past turns and your teammates' turns (lines prefixed with "TEAMMATE" share your side). Before drafting, scan it and AVOID restating points you OR a teammate have already made — the audience has already heard them. Treat a teammate's argument as covered ground: you may briefly reinforce or build on it, but do not repeat their example, statistic, or framing. Each turn must advance the debate with a fresh angle, a new piece of evidence, or a sharper rebuttal of something neither you nor your teammates have yet addressed. If your memory already shows the same example, statistic, or framing you were about to use, pick a different one.
