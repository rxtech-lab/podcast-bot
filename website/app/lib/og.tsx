...
// cover art on the left (or a gradient fallback) and the title/creator on the
// right. Used by both /d/[id] and /s/[token] opengraph-image routes.
export function renderOGImage(meta: DiscussionMeta | null): ImageResponse {
  const title = meta?.title ?? "Discussion";
